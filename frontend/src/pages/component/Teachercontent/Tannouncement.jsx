...
const TeacherAnnouncementPage = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      console.log("Teacher Announcements API Response:", response.data); // Debug log
      
      // Fix: Use the correct data path based on the working admin component
  ...
  useEffect(() => {
    fetchAnnouncements();
    const interval = setInterval(fetchAnnouncements, 60000); // Auto-fetch every 60s
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              {announcements.map((announcement) => {
                ...
                console.log("Teacher Announcement object:", announcement);
                ...
                return (
                  <div
                    key={announcementId}
                    className=" bg-opacity-40 backdrop-blur-md p-6 rounded-2xl shadow-md hover:shadow-xl transition"
                  >
